...
public class Settings {
    ...
    public static final String ipSource1 = "192.168.0.1";
    public static final String macSource1 = "AA:BB:CC:DD:EE:FF";

    public static final String ipSource2 = "192.168.0.2";
    public static final String macSource2 = "BB:CC:DD:EE:FF:GG";

    public static final String ipSource3 = "192.168.0.3";
    public static final String macSource3 = "CC:DD:EE:FF:GG:HH";

    public static final String ipSource4 = "192.168.0.4";
    public static final String macSource4 = "DD:EE:FF:GG:HH:II";
}
